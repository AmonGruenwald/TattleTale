...
\DoxyCodeLine{114         \textcolor{keywordtype}{bool} \mbox{\hyperlink{classtale_1_1_actor_a93cfa345c9e50d33484df2e1efebf683}{Actor::SlotEmpty}}(\textcolor{keywordtype}{size\_t} slot) \textcolor{keyword}{const};}
...
\DoxyCodeLine{196         \textcolor{keyword}{const} std::vector<std::weak\_ptr<Actor>> \&GetFreetimeActorGroup() \textcolor{keyword}{const};}
