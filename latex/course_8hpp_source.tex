...
\DoxyCodeLine{84         std::string ToString() \textcolor{keyword}{const};}
\DoxyCodeLine{85 }
\DoxyCodeLine{86     \textcolor{keyword}{private}:}
\DoxyCodeLine{90         std::vector<std::list<Actor *>> \mbox{\hyperlink{classtattletale_1_1_course_afd8a4c6e161409e438e80b773c9612e5}{slots\_}};}
\DoxyCodeLine{94         \mbox{\hyperlink{classtattletale_1_1_random}{Random}} \&\mbox{\hyperlink{classtattletale_1_1_course_aa49122a85ab09e9f212a3377dd0b35e5}{random\_}};}
\DoxyCodeLine{95         \textcolor{keyword}{const} \mbox{\hyperlink{structtattletale_1_1_setting}{Setting}} \&setting\_;}
\DoxyCodeLine{96     \};}
\DoxyCodeLine{97 }
\DoxyCodeLine{98 \} \textcolor{comment}{// namespace tattletale}}
\DoxyCodeLine{99 \textcolor{preprocessor}{\#endif }\textcolor{comment}{// TALE\_COURSE\_H}}
