...
\DoxyCodeLine{149         \textcolor{keywordtype}{bool} ReadPrototypeJSON(nlohmann::json json, \textcolor{keywordtype}{size\_t} participant\_count, std::string error\_preamble, InteractionPrototype \&out\_prototype);}
\DoxyCodeLine{150         \textcolor{keywordtype}{bool} ReadRequirementJSON(nlohmann::json json, std::string error\_preamble, Requirement \&out\_requirement);}
\DoxyCodeLine{151         \textcolor{keywordtype}{bool} ReadTendencyJSON(nlohmann::json json, \textcolor{keywordtype}{size\_t} participant\_count, std::string error\_preamble, Tendency \&out\_tendency);}
\DoxyCodeLine{152 }
...
\DoxyCodeLine{159                 \{}
\DoxyCodeLine{160                     TALE\_ERROR\_PRINT(fmt::format(\textcolor{stringliteral}{"{}\{\}JSON DID NOT CONTAIN KEY \{\}"{}}, error\_preamble, key));}
...
\DoxyCodeLine{171                 \{}
\DoxyCodeLine{172                     TALE\_ERROR\_PRINT(fmt::format(\textcolor{stringliteral}{"{}\{\}VALUE FOR KEY \{\} WAS OF AN INCORRECT TYPE"{}}, error\_preamble, key));}
...
\DoxyCodeLine{185                 \{}
\DoxyCodeLine{186                     TALE\_ERROR\_PRINT(fmt::format(\textcolor{stringliteral}{"{}\{\}JSON DID NOT CONTAIN INDEX \{\}"{}}, error\_preamble, index));}
...
\DoxyCodeLine{197                 \{}
\DoxyCodeLine{198                     TALE\_ERROR\_PRINT(fmt::format(\textcolor{stringliteral}{"{}\{\}VALUE FOR INDEX \{\} WAS OF AN INCORRECT TYPE"{}}, error\_preamble, index));}
...
\DoxyCodeLine{206     \};}
\DoxyCodeLine{207 \} \textcolor{comment}{// namespace tale}}
